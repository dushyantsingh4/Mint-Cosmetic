...
export default function ReveiewSection({ reviews, productId, averageRating }){
    ...
    return(
        <div className="container mx-auto p-6 bg-white">
            ...
            <div className="flex justify-center items-center gap-6 mb-4">
                <p className="text-2xl"><span className="text-gold"><i className="fa-solid fa-star"></i></span> {averageRating} </p>
